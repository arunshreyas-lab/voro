        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {businessCategories.map((category) => (
              <div
                key={category.title}
                className="flex items-center justify-between p-6 rounded-xl border border-border bg-card hover:bg-accent/5 hover:border-accent/20 transition-all duration-200 cursor-pointer group shadow-sm hover:shadow-md"
              >
